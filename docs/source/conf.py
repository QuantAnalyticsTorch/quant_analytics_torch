...
# ones.
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.autosummary', 'sphinx.ext.viewcode', 'sphinx.ext.napoleon','hoverxref.extension',"sphinx_design", "nbsphinx", 'sphinx_search.extension']
