    ...
    def run(self):
        ...
        for i in range(self.epochs):
            for j in range(self.training_size):
                ...
                #self.model.hidden_cell = (  torch.zeros(1, self.model.batch_size, self.model.hidden_layer_size),
                #                            torch.zeros(1, self.model.batch_size,  self.model.hidden_layer_size))

                self.init_hidden(self.batch_size)

                x0 = self.paths(self.batch_size)
